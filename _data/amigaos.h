  ...
  do                                            \
    {                                           \
      ...
      builtin_assert ("system=amigaos");	\
		...
		else if (IS_MCRT("amyclib"))		\
		{					\
			builtin_define_std ("amyclib");		\
			builtin_define_std ("AMYCLIB");		\
		}					\
...
%{shared: %(base_sdk)clib4/%(lib_subdir_clib4)/shcrtbegin.o} %{!shared: %(base_sdk)clib4/%(lib_subdir_clib4)/crtbegin.o}"
...
#define CPP_AMYCLIB_SPEC "\
-idirafter %(base_sdk)amyclib/include \
-idirafter %(base_sdk)local/amyclib/include"

#define LIB_SUBDIR_AMYCLIB_SPEC "\
lib%(lib_subdir_type)"

#define LINK_AMYCLIB_SPEC "\
-L%(base_sdk)amyclib/%(lib_subdir_amyclib) \
-L%(base_gcc)lib/gcc/ppc-amigaos/%(version)/amyclib/lib%(lib_subdir_type) \
-L%(base_sdk)local/amyclib/%(lib_subdir_amyclib)"

#define STARTFILE_AMYCLIB_SPEC "\
%(base_sdk)amyclib/%(lib_subdir_amyclib)/crtbegin.o"

#define ENDFILE_AMYCLIB_SPEC "\
%(base_sdk)amyclib/%(lib_subdir_amyclib)/crtend.o"
...
mcrt=amyclib: %(startfile_amyclib); \
...
#define SUBTARGET_EXTRA_SPECS \
  ...
  /* amyclib */ \
  {"cpp_amyclib", CPP_AMYCLIB_SPEC}, \
  {"lib_subdir_amyclib", LIB_SUBDIR_AMYCLIB_SPEC}, \
  {"link_amyclib", LINK_AMYCLIB_SPEC}, \
  {"startfile_amyclib", STARTFILE_AMYCLIB_SPEC}, \
  {"endfile_amyclib", ENDFILE_AMYCLIB_SPEC}, \
  /* ixemul */ \
